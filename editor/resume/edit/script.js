...
function updateTemplate(inputObj, templateID){
    let templatesHTML = {
        "template-1":  `<div class="preview-resume-content container-fluid" style="height:1121px"><div class="resume-header contact_info"><h3 class="contact-name mb-1" style="font-size: 1.6rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span> <span class="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #7a7a7a; font-weight: 500;">${inputObj['job-title']}</p></div><div class="row resume-body h-100">
        ...
        "template-2":  `<div class="preview-resume-content container-fluid" style="height:1121px"><div class="row resume-body h-100">
                        <div class="col-4 text-end pe-3" style="border-right: 1px solid #797979;"><div class="resume-header contact_info mb-5"><h3 class="contact-name mb-1" style="font-size: 1.6rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span><br><span class="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #7a7a7a; font-weight: 500;">${inputObj['job-title']}</p></div><div class="recipient_information my-2"><strong>To</strong><p class="my-1 recipient-name"><span class="recipient-title-name">${inputObj['recipient-title-name']}</span> <span class="recipient-firstname">${inputObj['recipient-firstname']}</span> <span class="recipient-lastname">${inputObj['recipient-lastname']}</span></p><p class="my-1 company-name">${inputObj['company-name']}</p></div><div class="contact_information my-4"><strong>From</strong><p class="my-1 contact-name"><span class="contact-firstname">${inputObj['contact-firstname']}</span> <span class="contact-lastname">${inputObj['contact-lastname']}</span></p><p class="my-1 job-title">${inputObj['job-title']}</p><p class="my-1 contact-address">${inputObj['contact-address']}</p><p class="my-1 contact-phone">${inputObj['contact-phone']}</p><p class="my-1"><a href="#" class="contact-email">${inputObj['contact-email']}</a></p></div></div>
        ...
        "template-3":  `<div class="preview-resume-content container-fluid" style="height: 1000px;"><div class="resume-header contact_info"><h3 class="contact-name mb-1" style="font-size: 2.2rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span><br><span class="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #7a7a7a; font-weight: 500;">${inputObj['job-title']}</p></div><div class="row resume-body h-100" style="border-top: 1px solid #797979;">
        ...
        "template-4":  `<div class="preview-resume-content container-fluid p-0" style="height:1121px"><div class="row resume-body h-100 m-0">
                        <div class="col-4 p-0" style="background: #373d48; color: #fff;"><div class="resume-header contact_info p-4 pb-2"><h2 class="contact-name mb-1" style="font-size: 1.6rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span> <span class="contact-lastname">${inputObj['contact-lastname']}</span></h2><p class="contact-job job-title" style="color: #afafaf; font-weight: 500;">${inputObj['job-title']}</p></div><div class="mb-2 px-4 py-3" style="background: #252930;"><h5 class="m-0 p-0">Personal Info</h5></div><div class="contact_information my-3 px-4"><strong>Phone</strong><p class="mb-3 contact-phone">${inputObj['contact-phone']}</p><strong>Email</strong><p class="mb-3"><a href="#" class="contact-email">${inputObj['contact-email']}</a></p><strong>Address</strong><p class="mb-3 contact-address">${inputObj['contact-address']}</p></div></div>
        ...
        "template-5":  `<div class="preview-resume-content container-fluid h-auto"><div class="resume-header contact_info"><h3 class="contact-name mb-1" style="font-size: 1.6rem;"><spanclass="contact-firstname">${inputObj['contact-firstname']}</span> <spanclass="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #7a7a7a; font-weight: 500;">${inputObj['job-title']}</p></div><div class="row resume-body h-100">
        ...
        "template-6":  `<div class="preview-resume-content container-fluid"><div class="resume-header contact_info"><h3 class="contact-name mb-1" style="font-size: 1.6rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span> <span class="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #7a7a7a; font-weight: 500;">${inputObj['job-title']}</p></div><div class="row resume-body h-100">
        ...
        "template-7":  `<div class="preview-resume-content container-fluid p-0" style="height:925px">
                        <div class="row m-0 p-0"><div class="col p-5 pb-3" style="background: #373d48; color: #fff; height: fit-content;"><div class="resume-header contact_info"><h3 class="contact-name mb-1" style="font-size: 1.6rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span> <span class="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #afafaf; font-weight: 500;">${inputObj['job-title']}</p></div><div class="contact_information"><p class="mb-1 p-0"><strong>Phone:</strong> <span class="contact-phone">${inputObj['contact-phone']}</span></p><p class="mb-1 p-0"><strong>Email:</strong> <span class=""><a href="#" class="contact-email">${inputObj['contact-email']}</a></span></p><p class="mb-1 p-0"><strong>Address:</strong> <span class="contact-address">${inputObj['contact-address']}</span></p></div></div></div>
                        <div class="row m-0 p-0 h-100"><div class="col h-100 p-5 pt-3"><div class="recipient_information mb-4"><p class="my-1 recipient-name"><strong class="recipient-firstname">${inputObj['recipient-firstname']}</strong> <strong class="recipient-lastname">${inputObj['recipient-lastname']}</strong></p><p class="my-1 company-name">${inputObj['company-name']}</p></div><p class="my-2"><span class="greeting">${inputObj['greeting']}</span> <span class="recipient-title-name">${inputObj['recipient-title-name']}</span><span class="recipient-firstname">${inputObj['recipient-firstname']}</span>,</p><div class="mb-3 body-content">${inputObj['body-content']}</div><i>Kind regards</i><p class="my-1 contact-name"><strong class="contact-firstname">${inputObj['contact-firstname']}</strong> <strong class="contact-lastname">${inputObj['contact-lastname']}</strong></p></div></div></div>`,

        "template-8":  `<div class="preview-resume-content container-fluid"><div class="resume-header contact_info"><h3 class="contact-name mb-1" style="font-size: 1.6rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span> <span class="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #7a7a7a; font-weight: 500;">${inputObj['job-title']}</p></div><div class="row resume-body h-100">
