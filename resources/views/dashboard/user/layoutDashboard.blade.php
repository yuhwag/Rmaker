        ...
        <div class="side-container nav-expanded">
            ...
            <div class="side-navigation">
                <ul>
                    ...
                    <a href="{{route('dashboard.user.documents')}}" class="documents nav-li @if($page == 'documents') li-active @endif"><span class="fa-solid fa-file"></span><span>Documents</span></a>
                    <!-- <a href="{{route('dashboard.user.favorites')}}" class="favorites nav-li @if($page == 'favorites') li-active @endif"><span class="fa-solid fa-heart"></span><span>Favorites</span></a> -->
                    <a href="{{route('dashboard.user.profile')}}" class="profile nav-li @if($page == 'profile') li-active @endif"><span class="fa-solid fa-circle-user"></span><span>Profile</span></a>
                    <a href="{{route('dashboard.user.setting')}}" class="setting nav-li @if($page == 'setting') li-active @endif"><span class="fa-solid fa-gear"></span><span>Setting</span></a>
                </ul>
