...
function updateTemplate(inputObj, templateID){
    let templatesHTML = {
        ...
        "template-2":  `<div class="preview-letter-content container-fluid" style="height:1121px"><div class="row cover-letter-body h-100">
        ...
        "template-4":  `<div class="preview-letter-content container-fluid p-0" style="height:1121px"><div class="row cover-letter-body h-100 m-0">
        ...
        "template-6":  `<div class="preview-letter-content container-fluid"><div class="cover_letter-header contact_info"><h3 class="contact-name mb-1" style="font-size: 1.6rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span> <span class="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #7a7a7a; font-weight: 500;">${inputObj['job-title']}</p></div><div class="row cover-letter-body h-100">
        ...
        "template-7":  `<div class="preview-letter-content container-fluid p-0" style="height:925px">
        ...
        "template-8":  `<div class="preview-letter-content container-fluid"><div class="cover_letter-header contact_info"><h3 class="contact-name mb-1" style="font-size: 1.6rem;"><span class="contact-firstname">${inputObj['contact-firstname']}</span> <span class="contact-lastname">${inputObj['contact-lastname']}</span></h3><p class="contact-job job-title" style="color: #7a7a7a; font-weight: 500;">${inputObj['job-title']}</p></div><div class="row cover-letter-body h-100">
